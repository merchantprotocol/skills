...
6. **Store observations too.** During this conversation, also fire `add_observational_memory` and write to the daily observation log — this conversation is the richest source of human-domain data you'll ever get.
